...
s.onload = function () {
    ...
    $(function () {
        ...
        function renderAd() {
            // adsense js
            var ad_client = "ca-pub-9280675451449007";
            ...
            switch (location.hostname) {
                default:
                    ...
                    // 分类页
                    insertGads("cate_ad_01", { client: ad_client, slot: "9187370867" });

                    // 详情页
                    insertGads("detail_ad_01", { client: ad_client, slot: "9187370867" });
                    insertGads("detail_ad_02", { client: ad_client, slot: "1275121630" });
                    insertGads("detail_ad_03", { client: ad_client, slot: "8962039969" });
                    insertGads("detail_ad_04", { client: ad_client, slot: "5252350500", format: "rectangle" });
                    // insertGads("detail_ad_04", { client: ad_client, slot: "4401202219", format: "fluid", layoutKey: "-h6-7+1j-3w+4l" });

                    // 游戏页
                    insertGads("play_ad_01", { client: ad_client, slot: "1037418101", format: 'auto' });
                    insertGads("play_ad_02", { client: ad_client, slot: "6178064146", format: 'auto' });
                    insertGads("play_ad_03", { client: ad_client, slot: "4864982474" });
            }
