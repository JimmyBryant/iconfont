...
s.onload = function () {
    ...
    $(function () {
        ...
        function renderAd() {
            // adsense js
            var ad_client = "ca-pub-8323747338160750";
            ...
            switch (location.hostname) {
                default:
                    ...
                    // 分类页
                    insertGads("cate_ad_01", { client: ad_client, slot: "8413391038" });

                    // 详情页
                    insertGads("detail_ad_01", { client: ad_client, slot: "8413391038" });
                    insertGads("detail_ad_02", { client: ad_client, slot: "1715286598" });
                    insertGads("detail_ad_03", { client: ad_client, slot: "9210633236" });
                    insertGads("detail_ad_04", { client: ad_client, slot: "1661052877", format: "rectangle" });
                    // insertGads("detail_ad_04", { client: ad_client, slot: "4401202219", format: "fluid", layoutKey: "-h6-7+1j-3w+4l" });

                    // 游戏页
                    insertGads("play_ad_01", { client: ad_client, slot: "5356206566", format: 'auto' });
                    insertGads("play_ad_02", { client: ad_client, slot: "4962482566", format: 'auto' });
                    insertGads("play_ad_03", { client: ad_client, slot: "4599041558" });
            }
