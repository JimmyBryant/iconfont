...
jq_s.onload = function () {
    ...
    $(function () {
        ...
        function renderAd() {
            ...
            $('head').append($('<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"  crossorigin="anonymous">'));
            ...
            switch (location.hostname) {
                default:
                    ...
                    // 详情页
                    insertGads("detail_ad_01", { client: ad_client, slot: "2965320282" });
                    insertGads("detail_ad_02", { client: ad_client, slot: "4100446167" });
                    insertGads("detail_ad_03", { client: ad_client, slot: "6848724978" });
                    insertGads("detail_ad_04", { client: ad_client, slot: "2858682539", format: "rectangle" });
